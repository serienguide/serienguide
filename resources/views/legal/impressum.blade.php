    ...
    <x-container class="py-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="text-md">
                ...
                <p class="mt-5">Quellenangaben für die verwendeten Bilder und Grafiken:</p>
                <p>
                    <a class="text-blue-500 hover:text-blue-600" rel="nofollow" href="http://www.thetvdb.org" target="_blank">
                        www.theTVDB.com
                    </a>
                </p>
                <p>
                    <a class="text-blue-500 hover:text-blue-600" rel="nofollow" href="http://www.themoviedb.org" target="_blank">
                        www.themoviedb.org
                    </a>
                </p>
