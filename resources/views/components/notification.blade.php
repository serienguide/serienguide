<div
    ...
    class="fixed inset-0 flex items-end justify-center mt-16 px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end"
>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-4 flex-shrink-0 flex">
                    <button class="bg-white rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        ...
                        <svg @click="show = false;" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
